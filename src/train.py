...
if __name__ == '__main__':
    ...
    train_dataset = datasets.ImageFolder(root=r'C:\\Users\\Administrator\Desktop\\msnet\\data\\train', transform=train_transform)
    ...
    # 初始化模型
    model = MobileNetV3(num_classes=5).to(device)
